...
public class x extends C0249a {
    ...
    private void a(int i, int i2, int i3, int i4) {
        if (this.k >= 10) {
            com.ihoc.mgpa.n.m.a("TGPA", "samsung sdk: update data to spa exception times > 10. ");
            return;
        }
        try {
            ...
            com.ihoc.mgpa.n.m.a("TGPA", "samsung sdk: write spa data exception. ");
            this.k++;
        }
    }
    ...
    private void a(String str, int i, int i2, int i3) {
        if (this.k >= 10) {
            com.ihoc.mgpa.n.m.a("TGPA", "samsung sdk: update data to spa is not available, or exception times > 10. ");
            return;
        }
        if (i2 == 0) {
            try {
    ...
    private void j() {
        try {
            ...
            if (this.e.initLowLatencyIPC("{\"1\":{\"name\":\"main version\",\"type\":\"string\",\"length\":\"16\"},\"2\":{\"name\":\"resource version\",\"type\":\"string\",\"length\":\"16\"},\"4\":{\"name\":\"scene\",\"type\":\"integer\",\"maximum\":\"1000\",\"minimum\":\"0\"},\"5\":{\"name\":\"fps\",\"type\":\"integer\",\"maximum\":\"60\",\"minimum\":\"0\"},\"6\":{\"name\":\"frame miss\",\"type\":\"integer\",\"maximum\":\"30\",\"minimum\":\"0\"},\"7\":{\"name\":\"limit fps\",\"type\":\"integer\",\"maximum\":\"60\",\"minimum\":\"0\"},\"8\":{\"name\":\"model quality\",\"type\":\"integer\"},\"9\":{\"name\":\"effect quality\",\"type\":\"integer\"},\"10\":{\"name\":\"resolution\",\"type\":\"label\",\"value\":{\"0\":\"720P\",\"1\":\"1080P\"}},\"11\":{\"name\":\"user count\",\"type\":\"integer\",\"maximum\":\"100\",\"minimum\":\"1\"},\"12\":{\"name\":\"network latency\",\"type\":\"integer\"},\"13\":{\"name\":\"record status\",\"type\":\"boolean\"},\"15\":{\"name\":\"server ip address\",\"type\":\"string\",\"length\":\"32\"},\"16\":{\"name\":\"role status\",\"type\":\"boolean\"},\"40\":{\"name\":\"scene type\",\"type\":\"integer\",\"maximum\":\"1000\",\"minimum\":\"0\"},\"41\":{\"name\":\"load map status\",\"type\":\"boolean\"},\"42\":{\"name\":\"bombing status\",\"type\":\"boolean\"},\"43\":{\"name\":\"multithread status\",\"type\":\"boolean\"},\"51\":{\"name\":\"heavy thread\",\"type\":\"integer\"},\"52\":{\"name\":\"role outline\",\"type\":\"boolean\"},\"53\":{\"name\":\"picture style\",\"type\":\"integer\"},\"54\":{\"name\":\"Anti-aliasing\",\"type\":\"integer\"},\"55\":{\"name\":\"Server IP port\",\"type\":\"integer\"},\"56\":{\"name\":\"protocol type\",\"type\":\"integer\"},\"57\":{\"name\":\"shadow\",\"type\":\"integer\"},\"80\":{\"name\":\"cpu level\",\"type\":\"integer\"},\"81\":{\"name\":\"gpu level\",\"type\":\"integer\"},\"82\":{\"name\":\"target fps\",\"type\":\"integer\"},\"83\":{\"name\":\"scene importance\",\"type\":\"integer\"},\"90\":{\"name\":\"tgpa version\",\"type\":\"string\",\"length\":\"16\"}}", this.j) != 0) {
                com.ihoc.mgpa.n.m.a("TGPA", "samsung sdk: init lowlatencyIPC failed. ");
                this.j.close();
            } else {
                this.d = true;
            }
            ...
            e.printStackTrace();
            com.ihoc.mgpa.n.m.a("TGPA", "samsung sdk: check spa exception. ");
        }
    }
    ...
    public String k() {
        ...
        com.ihoc.mgpa.n.m.a("TGPA", "SamSungSdkProxy:getGameSdkVersion: " + valueOf);
        return valueOf;
    }
    ...
    public void l() {
        String str;
        String str2;
        if (this.e.registerListener(new C0264p(this))) {
            str = "TGPA";
    ...
    public void a() {
        a(com.ihoc.mgpa.n.a.a(), new C0261m(this));
        new Thread(new RunnableC0262n(this)).start();
    }

    public void a(float f) {
        if (!this.d) {
            com.ihoc.mgpa.n.m.a("TGPA", "samsung sdk: sdk is not support or spa not support. ");
            return;
        }
        com.ihoc.mgpa.n.m.a("TGPA", "samsung sdk: spa register callback result: " + this.e.registerToTGPACallback(new C0265q(this), f));
    }
    ...
    public void a(Context context, InterfaceC0250b interfaceC0250b) {
        com.ihoc.mgpa.n.m.a("TGPA", "samsung sdk: ready to bind samsung server.");
        if (this.e == null) {
            this.e = new GameServiceHelper();
        }
        this.e.registerBindListener(new C0263o(this, interfaceC0250b));
        this.e.bind(context);
    }
    ...
    public void a(String str) {
        ...
        com.ihoc.mgpa.n.m.a("TGPA", "updateGameInfo: samsung json: " + str);
    ...
    */
    public void b(int r7, java.lang.String r8) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ihoc.mgpa.j.x.b(int, java.lang.String):void");
    }
    ...
    public String h() {
        ...
        com.ihoc.mgpa.n.m.a("TGPA", "SamSungSdkProxy:getVendorSupportStrategy: " + String.valueOf(vendorSupportStrategy));
        if (vendorSupportStrategy != null) {
            return vendorSupportStrategy;
        }
        com.ihoc.mgpa.n.m.a("TGPA", "samsung sdk: gamesdk get vendor strategy null.");
        return "ERROR";
    }
    ...
    public com.ihoc.mgpa.i.g i() {
        try {
            this.c = this.e.init();
            if (!this.e.init()) {
                com.ihoc.mgpa.n.m.a("[SamSungSdkProxy]: game service init failed.", new Object[0]);
            ...
            com.ihoc.mgpa.n.m.a("[SamSungSdkProxy]: game service init exception.", e);
