...
public class G extends C0249a {
    private static volatile G b;
    private TGPAManager c = new TGPAManager();
    private boolean d = false;
    private MgpaCallback e = null;
    private int f = -1;
    ...
    private void a(Context context, InterfaceC0250b interfaceC0250b) {
        this.c.bind(context, new E(this, interfaceC0250b));
    }

    private void a(String str, int i) {
        if (com.ihoc.mgpa.i.f.J()) {
            if (this.f == i) {
                com.ihoc.mgpa.n.m.a("TGPA", "tgpabinder2: frequecy level is same to last.");
                return;
            }
            if (i == 0) {
                com.ihoc.mgpa.n.m.a("TGPA", "tgpabinder2: frequecy level is 0, do not need notify.");
                return;
            }
            this.f = i;
    ...
    public void j() {
        this.c.registerGameCallback(new F(this));
    }

    @Override // com.ihoc.mgpa.j.C0249a, com.ihoc.mgpa.j.InterfaceC0253e
    public void a() {
        a(com.ihoc.mgpa.n.a.a(), new C(this));
    ...
    public void a(String str, String str2) {
        ...
        StringBuilder sb;
        String str3;
        com.ihoc.mgpa.n.m.a("TGPA", "tgpabinder2: callback type: " + String.valueOf(str) + " , value: " + String.valueOf(str2));
    ...
    public com.ihoc.mgpa.i.g i() {
        ...
        if (supportState == 0) {
            com.ihoc.mgpa.n.m.a("TGPA", "tgpabinder2 sdk is support.");
            this.d = true;
            return com.ihoc.mgpa.i.g.VMP_SUCCESS;
        }
        if (supportState == 1) {
            com.ihoc.mgpa.n.m.a("TGPA", "tgpabinder2 sdk auth failed.");
            return com.ihoc.mgpa.i.g.TGPA_BINDER_AUTH_FAILED;
        }
        if (supportState == -1) {
            com.ihoc.mgpa.n.m.a("TGPA", "tgpabinder2 sdk is not support.");
            return com.ihoc.mgpa.i.g.TGPA_BINDER_NOT_SUPPORT;
        }
        com.ihoc.mgpa.n.m.a("TGPA", "tgpabinder2 sdk check failed.");
