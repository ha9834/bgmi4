...
public class AmazonS3Client extends AmazonWebServiceClient implements AmazonS3 {
    ...
    public VersionListing listVersions(ListVersionsRequest listVersionsRequest) throws AmazonClientException, AmazonServiceException {
        ...
        if (z) {
            prefix = S3HttpUtils.urlEncode(listVersionsRequest.getPrefix(), true);
        } else {
            prefix = listVersionsRequest.getPrefix();
        }
        addParameterIfNotNull((Request<?>) createRequest, "prefix", prefix);
        ...
        if (z) {
            delimiter = S3HttpUtils.urlEncode(listVersionsRequest.getDelimiter(), true);
        } else {
            delimiter = listVersionsRequest.getDelimiter();
        }
        addParameterIfNotNull((Request<?>) createRequest, "delimiter", delimiter);
        ...
        return (VersionListing) invoke(createRequest, new Unmarshallers.VersionListUnmarshaller(z), listVersionsRequest.getBucketName(), (String) null);
    }
    ...
    public ObjectListing listObjects(ListObjectsRequest listObjectsRequest) throws AmazonClientException, AmazonServiceException {
        ...
        if (z) {
            prefix = S3HttpUtils.urlEncode(listObjectsRequest.getPrefix(), true);
        } else {
        ...
        if (z) {
            delimiter = S3HttpUtils.urlEncode(listObjectsRequest.getDelimiter(), true);
        } else {
        ...
        return (ObjectListing) invoke(createRequest, new Unmarshallers.ListObjectsUnmarshaller(z), listObjectsRequest.getBucketName(), (String) null);
    }
    ...
    public ListObjectsV2Result listObjectsV2(ListObjectsV2Request listObjectsV2Request) throws AmazonClientException, AmazonServiceException {
        ...
        return (ListObjectsV2Result) invoke(createRequest, new Unmarshallers.ListObjectsV2Unmarshaller(listObjectsV2Request.getEncodingType() == "url"), listObjectsV2Request.getBucketName(), (String) null);
    }
            ...
            if (!ServiceUtils.skipMd5CheckPerRequest(getObjectRequest) && !ServiceUtils.skipMd5CheckPerResponse(s3Object.getObjectMetadata())) {
                ...
                if (eTag != null) {
                    ...
                    if (!ServiceUtils.isMultipartUploadETag(eTag)) {
                        try {
                            filterInputStream2 = new DigestValidationInputStream(filterInputStream, MessageDigest.getInstance(com.adjust.sdk.Constants.MD5), BinaryUtils.fromHex(s3Object.getObjectMetadata().getETag()));
    ...
    public PutObjectResult putObject(PutObjectRequest putObjectRequest) throws AmazonClientException, AmazonServiceException {
        ...
        createRequest.setContent(inputStream5);
        try {
            try {
            ...
            try {
                ...
                log.debug("Unable to cleanly close input stream: " + e5.getMessage(), e5);
            }
            throw th;
        }
    }
    ...
    protected Signer createSigner(Request<?> request, String str, String str2) {
        ...
        if (!isSignerOverridden()) {
            ...
            if (signerRegionOverride != null) {
                ...
                aWSS3V4Signer2.setServiceName(getServiceNameIntern());
                aWSS3V4Signer2.setRegionName(signerRegionOverride);
    ...
    protected <T> void presignRequest(Request<T> request, HttpMethod httpMethod, String str, String str2, Date date, String str3) {
        ...
        sb.append(str4);
        sb.append(str2 != null ? S3HttpUtils.urlEncode(str2, true) : "");
        if (str3 != null) {
            str5 = "?" + str3;
        } else {
            str5 = "";
    ...
    private static void populateRequestWithCopyObjectParameters(Request<? extends AmazonWebServiceRequest> request, CopyObjectRequest copyObjectRequest) {
        String str = "/" + S3HttpUtils.urlEncode(copyObjectRequest.getSourceBucketName(), true) + "/" + S3HttpUtils.urlEncode(copyObjectRequest.getSourceKey(), true);
    ...
    private static void populateRequestWithCopyPartParameters(Request<?> request, CopyPartRequest copyPartRequest) {
        String str = "/" + S3HttpUtils.urlEncode(copyPartRequest.getSourceBucketName(), true) + "/" + S3HttpUtils.urlEncode(copyPartRequest.getSourceKey(), true);
    ...
    public void resolveRequestEndpoint(Request<?> request, String str, String str2, URI uri) {
        ...
        if (shouldUseVirtualAddressing(uri, str)) {
            ...
            request.setResourcePath(S3HttpUtils.urlEncode(getHostStyleResourcePath(str2), true));
        } else {
            request.setEndpoint(uri);
            if (str != null) {
                request.setResourcePath(S3HttpUtils.urlEncode(getPathStyleResourcePath(str, str2), true));
            }
        }
    }
