...
public class XmlResponsesSaxParser {
    ...
    public static class ListBucketHandler extends AbstractHandler {
        ...
        protected void doEndElement(String str, String str2, String str3) {
            if (atTopLevel()) {
                if (str2.equals("ListBucketResult") && this.objectListing.isTruncated() && this.objectListing.getNextMarker() == null) {
                    if (!this.objectListing.getObjectSummaries().isEmpty()) {
                        r7 = this.objectListing.getObjectSummaries().get(this.objectListing.getObjectSummaries().size() - 1).getKey();
                        ...
                        r7 = this.objectListing.getCommonPrefixes().get(this.objectListing.getCommonPrefixes().size() - 1);
                    }
                    this.objectListing.setNextMarker(r7);
                    return;
                }
                return;
            }
            ...
            if (str2.equals("IsTruncated")) {
                ...
                if (lowerCase.startsWith(CrashSight.SDK_IS_DEV)) {
    ...
    public static class CopyObjectResultHandler extends AbstractSSEHandler implements ObjectExpirationResult, S3RequesterChargedResult, S3VersionResult {
        ...
        protected void doEndElement(String str, String str2, String str3) {
            ...
            if (in("Error")) {
                if (str2.equals(DBInfoMeta.KEY_Code)) {
    ...
    public static class BucketVersioningConfigurationHandler extends AbstractHandler {
        ...
        protected void doEndElement(String str, String str2, String str3) {
            if (in("VersioningConfiguration")) {
                if (str2.equals(DBInfoMeta.KEY_Status)) {
    ...
    public static class BucketAccelerateConfigurationHandler extends AbstractHandler {
        ...
        @Override // com.amazonaws.services.s3.model.transform.AbstractHandler
        protected void doEndElement(String str, String str2, String str3) {
            if (in("AccelerateConfiguration") && str2.equals(DBInfoMeta.KEY_Status)) {
                this.configuration.setStatus(getText());
            }
        }
    }
    ...
    public static class DeleteObjectsHandler extends AbstractHandler {
        ...
        protected void doEndElement(String str, String str2, String str3) {
            ...
            if (in("DeleteResult", "Error")) {
                ...
                } else if (str2.equals(DBInfoMeta.KEY_Code)) {
    ...
    public static class ListBucketMetricsConfigurationsHandler extends AbstractHandler {
        ...
        protected void doEndElement(String str, String str2, String str3) {
            if (in("ListMetricsConfigurationsResult")) {
                ...
                if (str2.equals("IsTruncated")) {
                    this.result.setTruncated(ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equals(getText()));
                    return;
        ...
        protected void doEndElement(String str, String str2, String str3) {
            if (in("InventoryConfiguration")) {
                ...
                if (str2.equals("IsEnabled")) {
                    this.configuration.setEnabled(Boolean.valueOf(ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equals(getText())));
                    return;
                }
                if (str2.equals("Filter")) {
    ...
    public static class ListBucketInventoryConfigurationsHandler extends AbstractHandler {
        ...
        protected void doEndElement(String str, String str2, String str3) {
            ...
            if (in("ListInventoryConfigurationsResult", "InventoryConfiguration")) {
                ...
                if (str2.equals("IsEnabled")) {
                    this.currentConfiguration.setEnabled(Boolean.valueOf(ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equals(getText())));
                    return;
                }
                if (str2.equals("Filter")) {
