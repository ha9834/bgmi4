...
class S3CryptoModuleAE extends S3CryptoModuleBase<MultipartUploadCryptoContext> {
    ...
    private S3Object decipherWithInstructionFile(GetObjectRequest getObjectRequest, long[] jArr, long[] jArr2, S3ObjectWrapper s3ObjectWrapper, S3ObjectWrapper s3ObjectWrapper2) {
        ...
        boolean z;
        ExtraMaterialsDescription extraMaterialsDescription2 = ExtraMaterialsDescription.NONE;
        ...
        ContentCryptoMaterial fromInstructionFile = ContentCryptoMaterial.fromInstructionFile(unmodifiableMap, this.kekMaterialsProvider, this.cryptoConfig.getCryptoProvider(), jArr2, extraMaterialsDescription, z, this.kms);
    ...
    private S3Object decipherWithMetadata(GetObjectRequest getObjectRequest, long[] jArr, long[] jArr2, S3ObjectWrapper s3ObjectWrapper) {
        ...
        ContentCryptoMaterial fromObjectMetadata = ContentCryptoMaterial.fromObjectMetadata(s3ObjectWrapper.getObjectMetadata(), this.kekMaterialsProvider, this.cryptoConfig.getCryptoProvider(), jArr2, extraMaterialsDescription, z, this.kms);
    ...
    private S3ObjectWrapper decrypt(S3ObjectWrapper s3ObjectWrapper, ContentCryptoMaterial contentCryptoMaterial, long[] jArr) {
        S3ObjectInputStream objectContent = s3ObjectWrapper.getObjectContent();
        s3ObjectWrapper.setObjectContent(new S3ObjectInputStream(new CipherLiteInputStream(objectContent, contentCryptoMaterial.getCipherLite(), ProgressEvent.PART_COMPLETED_EVENT_CODE), objectContent.getHttpRequest()));
        return s3ObjectWrapper;
    }
