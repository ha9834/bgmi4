...
public class RegionMetadataParser {
    ...
    private static void addRegionEndpoint(Region region, Element element, boolean z) {
        ...
        region.getHttpSupport().put(childElementValue, Boolean.valueOf(ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equals(childElementValue3)));
        region.getHttpsSupport().put(childElementValue, Boolean.valueOf(ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equals(childElementValue4)));
    }
