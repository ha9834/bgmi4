...
public final class zzej extends gq {
    private final SSLSocketFactory b;

    public zzej(zzjg zzjgVar) {
        super(zzjgVar);
        this.b = Build.VERSION.SDK_INT < 19 ? new gw() : null;
    }
    ...
    public static /* synthetic */ byte[] a(zzej zzejVar, HttpURLConnection httpURLConnection) throws IOException {
