...
public final class GoogleAuthUtil extends zzd {
    ...
    private static final String f1214a = zzd.KEY_CALLER_UID;
    private static final String b = zzd.KEY_ANDROID_PACKAGE_NAME;
    ...
    public static String getTokenWithNotification(Context context, Account account, String str, Bundle bundle) throws IOException, UserRecoverableNotifiedException, GoogleAuthException {
        ...
        return a(context, account, str, bundle).zzb();
    }
    ...
    private static TokenData a(Context context, Account account, String str, Bundle bundle) throws IOException, GoogleAuthException {
        if (bundle == null) {
            bundle = new Bundle();
        }
        try {
