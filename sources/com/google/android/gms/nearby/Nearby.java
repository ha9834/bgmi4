...
public final class Nearby {
    ...
    @Hide
    private static zzd f4961a = new zzby();

    @Hide
    private static Api<Api.ApiOptions.NoOptions> b = new Api<>("Nearby.BOOTSTRAP_API", zzcoj.zzegv, zzcoj.zzegu);

    @Hide
    private static zzcoh c = new zzcoj();
