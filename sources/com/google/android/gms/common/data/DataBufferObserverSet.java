...
public final class DataBufferObserverSet implements DataBufferObserver.Observable, DataBufferObserver {
    ...
    private HashSet<DataBufferObserver> f1416a = new HashSet<>();
    ...
    public final void addObserver(DataBufferObserver dataBufferObserver) {
        this.f1416a.add(dataBufferObserver);
    }

    @Override // com.google.android.gms.common.data.DataBufferObserver.Observable
    public final void removeObserver(DataBufferObserver dataBufferObserver) {
        this.f1416a.remove(dataBufferObserver);
    }

    @Override // com.google.android.gms.common.data.DataBufferObserver
    public final void onDataChanged() {
        Iterator<DataBufferObserver> it = this.f1416a.iterator();
        while (it.hasNext()) {
