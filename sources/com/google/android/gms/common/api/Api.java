...
public final class Api<O extends ApiOptions> {
    ...
    private final AbstractClientBuilder<?, O> f1286a;
    ...
    public <C extends Client> Api(String str, AbstractClientBuilder<C, O> abstractClientBuilder, ClientKey<C> clientKey) {
        ...
        this.e = str;
        this.f1286a = abstractClientBuilder;
        this.b = null;
        this.c = clientKey;
        this.d = null;
    }
    ...
    public final AbstractClientBuilder<?, O> zai() {
        Preconditions.checkState(this.f1286a != null, "This API was constructed with a SimpleClientBuilder. Use getSimpleClientBuilder");
        return this.f1286a;
    }
