...
public final class GooglePlayServicesUtil extends GooglePlayServicesUtilLight {
    ...
    public static boolean showErrorDialogFragment(int i, Activity activity, Fragment fragment, int i2, DialogInterface.OnCancelListener onCancelListener) {
        ...
        Dialog a2 = GoogleApiAvailability.a(activity, i, DialogRedirect.getInstance(fragment, GoogleApiAvailability.getInstance().getErrorResolutionIntent(activity, i, com.nostra13.universalimageloader.core.d.f5744a), i2), onCancelListener);
        if (a2 == null) {
            return false;
        }
