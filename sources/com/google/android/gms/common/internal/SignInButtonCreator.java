...
public final class SignInButtonCreator extends RemoteCreator<ISignInButtonCreator> {
    ...
    private static final SignInButtonCreator f1463a = new SignInButtonCreator();
    ...
    public static View createView(Context context, int i, int i2) throws RemoteCreator.RemoteCreatorException {
        return f1463a.a(context, i, i2);
    }

    private final View a(Context context, int i, int i2) throws RemoteCreator.RemoteCreatorException {
        try {
