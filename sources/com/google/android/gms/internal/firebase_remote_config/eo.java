...
interface eo {
    ...
    <K, V> void a(int i, ct<K, V> ctVar, Map<K, V> map) throws IOException;

    void a(int i, zzfx zzfxVar) throws IOException;

    void a(int i, Object obj) throws IOException;

    void a(int i, Object obj, dm dmVar) throws IOException;

    void a(int i, String str) throws IOException;

    void a(int i, List<String> list) throws IOException;

    void a(int i, List<?> list, dm dmVar) throws IOException;
    ...
    @Deprecated
    void b(int i, Object obj, dm dmVar) throws IOException;

    void b(int i, List<zzfx> list) throws IOException;

    @Deprecated
    void b(int i, List<?> list, dm dmVar) throws IOException;
