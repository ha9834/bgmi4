...
public final class da {
    /* JADX INFO: Access modifiers changed from: package-private */
    public static String a(zzim zzimVar, String str) {
    ...
    private static void a(zzim zzimVar, StringBuilder sb, int i) {
        boolean booleanValue;
        boolean z;
        HashMap hashMap = new HashMap();
        HashMap hashMap2 = new HashMap();
        TreeSet<String> treeSet = new TreeSet();
        for (Method method : zzimVar.getClass().getDeclaredMethods()) {
        ...
        for (String str : treeSet) {
            ...
            if (replaceFirst.endsWith("List") && !replaceFirst.endsWith("OrBuilderList") && !replaceFirst.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    a(sb, i, a(concat), zzhh.a(method2, zzimVar, new Object[0]));
                }
            }
            if (replaceFirst.endsWith("Map") && !replaceFirst.equals("Map")) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    a(sb, i, a(concat2), zzhh.a(method3, zzimVar, new Object[0]));
                }
            }
            ...
            if (((Method) hashMap2.get(valueOf5.length() != 0 ? "set".concat(valueOf5) : new String("set"))) != null) {
                ...
                if (method4 != null) {
                    Object a2 = zzhh.a(method4, zzimVar, new Object[0]);
                    if (method5 == null) {
                        if (a2 instanceof Boolean) {
                            ...
                            z = a2.equals("");
                        } else if (a2 instanceof zzfx) {
                            z = a2.equals(zzfx.zzow);
                        } else if (a2 instanceof zzim) {
                            z = a2 == ((zzim) a2).zzgx();
                        ...
                        booleanValue = ((Boolean) zzhh.a(method5, zzimVar, new Object[0])).booleanValue();
                    }
                    if (booleanValue) {
                        a(sb, i, a(concat3), a2);
                    }
        ...
        if (zzimVar instanceof zzhh.zzb) {
            Iterator<Map.Entry<Object, Object>> d = ((zzhh.zzb) zzimVar).zztj.d();
            if (d.hasNext()) {
                d.next().getKey();
                throw new NoSuchMethodError();
            }
        }
        zzhh zzhhVar = (zzhh) zzimVar;
        if (zzhhVar.zztg != null) {
            zzhhVar.zztg.a(sb, i);
        }
    }
    ...
    public static final void a(StringBuilder sb, int i, String str, Object obj) {
        ...
        if (obj instanceof String) {
            sb.append(": \"");
            sb.append(ea.a(zzfx.zzbj((String) obj)));
            sb.append('\"');
            return;
        }
        if (obj instanceof zzfx) {
            sb.append(": \"");
            sb.append(ea.a((zzfx) obj));
            sb.append('\"');
            return;
        }
