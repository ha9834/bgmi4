...
final class bw extends bg<Double> implements di, zzff<Double>, RandomAccess {

    /* renamed from: a, reason: collision with root package name */
    private static final bw f4492a;
    private double[] b;
    private int c;
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < this.c; i2++) {
            i = (i * 31) + zzez.zzbx(Double.doubleToLongBits(this.b[i2]));
        }
        return i;
    }
