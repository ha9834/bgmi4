...
final class bj extends bg<Boolean> implements di, zzff<Boolean>, RandomAccess {

    /* renamed from: a, reason: collision with root package name */
    private static final bj f4487a;
    private boolean[] b;
    private int c;
    ...
    public final /* synthetic */ zzff<Boolean> zzap(int i) {
        ...
        return new bj(Arrays.copyOf(this.b, i), this.c);
    }
    ...
    static {
        bj bjVar = new bj(new boolean[0], 0);
        f4487a = bjVar;
        bjVar.zzry();
    }
}
