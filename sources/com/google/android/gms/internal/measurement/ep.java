...
interface ep {
    ...
    <K, V> void a(int i, cu<K, V> cuVar, Map<K, V> map) throws IOException;

    void a(int i, zzdp zzdpVar) throws IOException;

    void a(int i, Object obj) throws IOException;

    void a(int i, Object obj, dl dlVar) throws IOException;

    void a(int i, String str) throws IOException;

    void a(int i, List<String> list) throws IOException;

    void a(int i, List<?> list, dl dlVar) throws IOException;
    ...
    @Deprecated
    void b(int i, Object obj, dl dlVar) throws IOException;

    void b(int i, List<zzdp> list) throws IOException;

    @Deprecated
    void b(int i, List<?> list, dl dlVar) throws IOException;
