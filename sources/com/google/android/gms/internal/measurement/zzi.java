...
public final class zzi {
    ...
    private final JobScheduler f4570a;
    ...
    private final int a(JobInfo jobInfo, String str, int i, String str2) {
        ...
        if (method != null) {
            try {
                return ((Integer) method.invoke(this.f4570a, jobInfo, str, Integer.valueOf(i), str2)).intValue();
            } catch (IllegalAccessException | InvocationTargetException e) {
                Log.e(str2, "error calling scheduleAsPackage", e);
            }
        }
        return this.f4570a.schedule(jobInfo);
    }
    ...
    public static int zza(Context context, JobInfo jobInfo, String str, String str2) {
        ...
        return new zzi(jobScheduler).a(jobInfo, str, c(), str2);
    }
}
