...
public final class afr extends aem<Integer> implements agr, zzdoh, RandomAccess {

    /* renamed from: a, reason: collision with root package name */
    private static final afr f1853a;
    private int[] b;
    private int c;
    ...
    public final zzdoh zzfl(int i) {
        ...
        return new afr(Arrays.copyOf(this.b, i), this.c);
    }
    ...
    public final boolean addAll(Collection<? extends Integer> collection) {
        a();
        zzdod.a(collection);
        if (!(collection instanceof afr)) {
            return super.addAll(collection);
        }
        afr afrVar = (afr) collection;
        int i = afrVar.c;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(afrVar.b, 0, this.b, this.c, afrVar.c);
        this.c = i3;
        this.modCount++;
        return true;
    }
    ...
    static {
        afr afrVar = new afr(new int[0], 0);
        f1853a = afrVar;
        afrVar.zzavj();
    }
}
