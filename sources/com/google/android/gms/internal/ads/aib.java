...
interface aib {
    ...
    <K, V> void a(int i, age<K, V> ageVar, Map<K, V> map) throws IOException;

    void a(int i, zzdmr zzdmrVar) throws IOException;

    void a(int i, Object obj) throws IOException;

    void a(int i, Object obj, agx agxVar) throws IOException;

    void a(int i, String str) throws IOException;

    void a(int i, List<String> list) throws IOException;

    void a(int i, List<?> list, agx agxVar) throws IOException;
    ...
    @Deprecated
    void b(int i, Object obj, agx agxVar) throws IOException;

    void b(int i, List<zzdmr> list) throws IOException;

    @Deprecated
    void b(int i, List<?> list, agx agxVar) throws IOException;
