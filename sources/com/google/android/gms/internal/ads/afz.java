...
final class afz extends aem<Long> implements agr, zzdoj<Long>, RandomAccess {

    /* renamed from: a, reason: collision with root package name */
    private static final afz f1858a;
    private long[] b;
    private int c;
    ...
    public final boolean addAll(Collection<? extends Long> collection) {
        a();
        zzdod.a(collection);
        if (!(collection instanceof afz)) {
            return super.addAll(collection);
        }
        afz afzVar = (afz) collection;
        int i = afzVar.c;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(afzVar.b, 0, this.b, this.c, afzVar.c);
        this.c = i3;
        this.modCount++;
        return true;
    }
    ...
    public final /* synthetic */ zzdoj<Long> zzfl(int i) {
        ...
        return new afz(Arrays.copyOf(this.b, i), this.c);
    }
    ...
    static {
        afz afzVar = new afz(new long[0], 0);
        f1858a = afzVar;
        afzVar.zzavj();
    }
}
