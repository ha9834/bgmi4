...
public class zzaxr extends zzaxt {
    ...
    public final String getDefaultUserAgent(Context context) {
        ...
        if (TextUtils.isEmpty(zzws.f2841a)) {
            if (ClientLibraryUtils.isPackageSide()) {
                str = (String) zzazl.zza(context, new gl(zzws, context));
            } else {
                str = (String) zzazl.zza(context, new gm(zzws, GooglePlayServicesUtilLight.getRemoteContext(context), context));
            }
            zzws.f2841a = str;
        }
        return zzws.f2841a;
    ...
    public final void zzay(Context context) {
        ...
        if (!defaultUserAgent.equals(zzws.f2841a)) {
