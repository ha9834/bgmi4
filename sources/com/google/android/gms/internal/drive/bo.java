...
final class bo extends TaskApiCall<zzaw, MetadataBuffer> {
    ...
    private final /* synthetic */ DriveResource f3907a;

    /* JADX INFO: Access modifiers changed from: package-private */
    public bo(zzch zzchVar, DriveResource driveResource) {
        this.f3907a = driveResource;
    }
    ...
    public final /* synthetic */ void a(zzaw zzawVar, TaskCompletionSource<MetadataBuffer> taskCompletionSource) throws RemoteException {
        ((zzeo) zzawVar.getService()).zza(new zzex(this.f3907a.getDriveId()), new zzhi(taskCompletionSource));
    }
}
