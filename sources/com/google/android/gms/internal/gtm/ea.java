...
final class ea extends dz {
            ...
            if (d) {
                ...
                if (!e) {
                    ...
                    if (f) {
                        if (i6 < i3 - 1) {
                            int i8 = i6 + 1;
                            dy.b(b2, bArr[i6], bArr[i8], cArr, i5);
                            i = i8 + 1;
                            i5++;
                        } else {
                            throw zzrk.h();
                        ...
                        byte b4 = bArr[i6];
                        int i10 = i9 + 1;
                        dy.b(b2, b4, bArr[i9], bArr[i10], cArr, i5);
                        i = i10 + 1;
                        i5 = i5 + 1 + 1;
                    }
                } else if (i6 < i3) {
                    dy.b(b2, bArr[i6], cArr, i5);
                    i = i6 + 1;
                    i5++;
                } else {
                    throw zzrk.h();
    ...
    */
    public final int a(java.lang.CharSequence r8, byte[] r9, int r10, int r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.gtm.ea.a(java.lang.CharSequence, byte[], int, int):int");
    }
