...
public final class cq {
    ...
    private static void a(zzsk zzskVar, StringBuilder sb, int i) {
        ...
        for (String str : treeSet) {
            ...
            if (((Method) hashMap2.get(valueOf5.length() != 0 ? "set".concat(valueOf5) : new String("set"))) != null) {
                ...
                if (method4 != null) {
                    Object a2 = zzrc.a(method4, zzskVar, new Object[0]);
                    if (method5 == null) {
                        if (a2 instanceof Boolean) {
                            ...
                            z = a2.equals("");
                        } else if (a2 instanceof zzps) {
                            z = a2.equals(zzps.zzavx);
                        } else if (a2 instanceof zzsk) {
                            z = a2 == ((zzsk) a2).zzpi();
    ...
    public static final void a(StringBuilder sb, int i, String str, Object obj) {
        ...
        if (obj instanceof String) {
            sb.append(": \"");
            sb.append(Cdo.a(zzps.zzcy((String) obj)));
            sb.append('\"');
            return;
        }
        if (obj instanceof zzps) {
            sb.append(": \"");
            sb.append(Cdo.a((zzps) obj));
            sb.append('\"');
            return;
        }
