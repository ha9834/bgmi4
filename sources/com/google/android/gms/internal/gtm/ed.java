...
interface ed {
    ...
    @Deprecated
    void b(int i, Object obj, da daVar) throws IOException;

    void b(int i, List<zzps> list) throws IOException;

    @Deprecated
    void b(int i, List<?> list, da daVar) throws IOException;
