...
public class dd<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static <FieldDescriptorType extends zzqv<FieldDescriptorType>> dd<FieldDescriptorType, Object> a(int i) {
        return new de(i);
    }
    ...
    public boolean containsKey(Object obj) {
        ...
        return a((dd<K, V>) comparable) >= 0 || this.c.containsKey(comparable);
    }
    ...
    public final V a(K k, V v) {
        ...
        if (this.b.isEmpty() && !(this.b instanceof ArrayList)) {
            this.b = new ArrayList(this.f4344a);
        }
        int i = -(a2 + 1);
        if (i >= this.f4344a) {
            return g().put(k, v);
        ...
        int i2 = this.f4344a;
        if (size == i2) {
            dk remove = this.b.remove(i2 - 1);
            g().put((Comparable) remove.getKey(), remove.getValue());
        }
        this.b.add(i, new dk(this, k, v));
        return null;
    }
    ...
    public final V c(int i) {
        ...
        if (!this.c.isEmpty()) {
            ...
            this.b.add(new dk(this, it.next()));
            it.remove();
        }
        return v;
    }
    ...
    public boolean equals(Object obj) {
        ...
        int c = c();
        if (c != ddVar.c()) {
            return entrySet().equals(ddVar.entrySet());
        }
        for (int i = 0; i < c; i++) {
            if (!b(i).equals(ddVar.b(i))) {
                return false;
            }
        }
        if (c != size) {
            return this.c.equals(ddVar.c);
        }
        return true;
    }
    ...
    public /* synthetic */ Object put(Object obj, Object obj2) {
        return a((dd<K, V>) obj, (Comparable) obj2);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public /* synthetic */ dd(int i, de deVar) {
        this(i);
    }
}
