...
public final class dx {
    ...
    private static final dz f4356a;

    public static boolean a(byte[] bArr) {
        return f4356a.a(bArr, 0, bArr.length);
    }
    ...
    public static int a(CharSequence charSequence, byte[] bArr, int i, int i2) {
        return f4356a.a(charSequence, bArr, i, i2);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static String b(byte[] bArr, int i, int i2) throws zzrk {
        return f4356a.b(bArr, i, i2);
    }
    ...
    public static void a(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        if (byteBuffer.hasArray()) {
            ...
            dzVar.a(charSequence, byteBuffer);
        } else {
            dz.b(charSequence, byteBuffer);
        }
    }
