...
public final class FirebaseAnalytics {
    ...
    public final void logEvent(String str, Bundle bundle) {
        if (this.zzl) {
            ...
            this.zzj.zzq().zza(Constants.JumpUrlConstants.SRC_TYPE_APP, str, bundle, true);
        }
    }
    ...
    public final void setUserProperty(String str, String str2) {
        if (this.zzl) {
            ...
            this.zzj.zzq().zzb(Constants.JumpUrlConstants.SRC_TYPE_APP, str, str2, false);
        }
    }
    ...
    public final void setUserId(String str) {
        if (this.zzl) {
            ...
            this.zzj.zzq().zzb(Constants.JumpUrlConstants.SRC_TYPE_APP, "_id", str, true);
        }
    }
