...
public class MagicRequest {
    ...
    class RunTask implements Runnable {
        ...
        private void dealTask() {
            ...
            MagicRequest.response(MagicRequest.this.mDelegate, i, this.mTask.mSession, this.mTask.mSeq, this.mTask.mEnd, byteArrayOutputStream != null ? byteArrayOutputStream.toByteArray() : null);
        }
    }
}
