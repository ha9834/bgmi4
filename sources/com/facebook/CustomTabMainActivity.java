...
public class CustomTabMainActivity extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (bundle == null) {
            ...
            if (!openCustomTab) {
                ...
                a.a(this).a(this.redirectReceiver, new IntentFilter(CustomTabActivity.CUSTOM_TAB_REDIRECT_ACTION));
            }
        }
    }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (REFRESH_ACTION.equals(intent.getAction())) {
            a.a(this).a(new Intent(CustomTabActivity.DESTROY_ACTION));
            sendResult(-1, intent);
    ...
    private void sendResult(int i, Intent intent) {
        a.a(this).a(this.redirectReceiver);
        if (intent != null) {
