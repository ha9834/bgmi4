...
public final class ModelManager {
    ...
    public static class TaskHandler {
        ...
        static TaskHandler build(JSONObject jSONObject) {
            ...
            try {
                return new TaskHandler(jSONObject.getString(ModelManager.USE_CASE_KEY), jSONObject.getString(ModelManager.ASSET_URI_KEY), jSONObject.optString(ModelManager.RULES_URI_KEY, null), jSONObject.getInt("version_id"), ModelManager.access$400(jSONObject.getJSONArray(ModelManager.THRESHOLD_KEY)));
        ...
        static void execute(TaskHandler taskHandler, final List<TaskHandler> list) {
            ...
            download(taskHandler.assetUri, taskHandler.useCase + EventsFilesManager.ROLL_OVER_FILE_NAME_SEPARATOR + taskHandler.versionId, new FileDownloadTask.Callback() { // from class: com.facebook.appevents.ml.ModelManager.TaskHandler.1
                @Override // com.facebook.appevents.internal.FileDownloadTask.Callback
                public void onComplete(File file) {
                    final Model build = Model.build(file);
                    if (build != null) {
                        for (final TaskHandler taskHandler2 : list) {
                            TaskHandler.download(taskHandler2.ruleUri, taskHandler2.useCase + EventsFilesManager.ROLL_OVER_FILE_NAME_SEPARATOR + taskHandler2.versionId + "_rule", new FileDownloadTask.Callback() { // from class: com.facebook.appevents.ml.ModelManager.TaskHandler.1.1
                                @Override // com.facebook.appevents.internal.FileDownloadTask.Callback
                                public void onComplete(File file2) {
                                    TaskHandler taskHandler3 = taskHandler2;
                                    taskHandler3.model = build;
                                    taskHandler3.ruleFile = file2;
