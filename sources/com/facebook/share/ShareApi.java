...
public final class ShareApi {
    ...
    private void addCommonParameters(Bundle bundle, ShareContent shareContent) {
        ...
        try {
            ...
            bundle.putString(RecommendParams.KEY_REFFER, shareContent.getRef());
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
        }
    }
            ...
            try {
                for (SharePhoto sharePhoto : sharePhotoContent.getPhotos()) {
                    try {
                        ...
                        String message = caption == null ? getMessage() : caption;
                        if (bitmap != null) {
                            arrayList.add(GraphRequest.newUploadPhotoRequest(currentAccessToken, getGraphPath(PHOTOS_EDGE), bitmap, message, sharePhotoCommonParameters, callback));
                        } else if (imageUrl != null) {
                            arrayList.add(GraphRequest.newUploadPhotoRequest(currentAccessToken, getGraphPath(PHOTOS_EDGE), imageUrl, message, sharePhotoCommonParameters, callback));
                        }
    ...
    private void shareLinkContent(ShareLinkContent shareLinkContent, final FacebookCallback<Sharer.Result> facebookCallback) {
        ...
        try {
            ...
            bundle.putString(RecommendParams.KEY_REFFER, shareLinkContent.getRef());
    ...
    private Bundle getSharePhotoCommonParameters(SharePhoto sharePhoto, SharePhotoContent sharePhotoContent) throws JSONException {
        ...
        try {
            ...
            if (!parameters.containsKey(RecommendParams.KEY_REFFER) && !Utility.isNullOrEmpty(sharePhotoContent.getRef())) {
                parameters.putString(RecommendParams.KEY_REFFER, sharePhotoContent.getRef());
            }
            return parameters;
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
        ...
        try {
            ...
            stageCollectionValues(collection, new CollectionMapper.OnMapperCompleteListener() { // from class: com.facebook.share.ShareApi.11
                ...
                public void onComplete() {
                    ...
                    try {
                        new GraphRequest(AccessToken.getCurrentAccessToken(), ShareApi.access$100(ShareApi.this, "objects/" + URLEncoder.encode(string2, "UTF-8")), bundle, HttpMethod.POST, callback).executeAsync();
                    } catch (UnsupportedEncodingException e) {
                        String localizedMessage = e.getLocalizedMessage();
                        if (localizedMessage == null) {
