...
public final class EndToEndDumpsysHelper {
        ...
        try {
            ...
            if (listActiveRoots != null && !listActiveRoots.isEmpty()) {
                ...
                for (AndroidRootResolver.Root root : listActiveRoots) {
                    if (root.getView().getVisibility() == 0) {
    ...
    private void writeLithoViewSubHierarchy(PrintWriter printWriter, View view, String str, boolean z) {
        try {
            ...
            printWriter.append((CharSequence) this.mLithoViewToStringMethod.invoke(null, view, Integer.valueOf((str.length() / 2) + 1), Boolean.valueOf(z)));
        } catch (Exception e) {
    ...
    private static void writeViewTestId(PrintWriter printWriter, View view) {
        ...
        try {
            ...
            if (id > 0 && resources != null) {
                int i = (-16777216) & id;
                if (i != 16777216) {
                    str = i != 2130706432 ? resources.getResourcePackageName(id) : Constants.JumpUrlConstants.SRC_TYPE_APP;
                } else {
                    str = "android";
                }
                printWriter.print(" ");
    ...
    private static void writeViewText(PrintWriter printWriter, View view) {
        ...
        try {
            ...
            if (trim != null && !trim.isEmpty()) {
                ...
                printWriter.print(fixString(trim, ScribeConfig.DEFAULT_SEND_INTERVAL_SECONDS));
                printWriter.print("\"");
            }
        } catch (Exception unused) {
        }
        ...
        static void writeExtraProps(PrintWriter printWriter, View view) {
            ...
            if (Build.VERSION.SDK_INT >= 21 && (createNodeInfoFromView = EndToEndDumpsysHelper.createNodeInfoFromView(view)) != null) {
                ...
                try {
                    ...
                    Iterator<AccessibilityNodeInfo.AccessibilityAction> it = createNodeInfoFromView.getActionList().iterator();
                    while (it.hasNext()) {
                    ...
                    if (jSONArray.length() > 0) {
                        jSONObject.put(ActionTable.TABLE_NAME, jSONArray);
                    }
