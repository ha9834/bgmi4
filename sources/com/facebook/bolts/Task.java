...
public class Task<TResult> {
    ...
    static Task<Void> delay(long j, ScheduledExecutorService scheduledExecutorService, CancellationToken cancellationToken) {
        ...
        final ScheduledFuture<?> schedule = scheduledExecutorService.schedule(new Runnable() { // from class: com.facebook.bolts.Task.1
            ...
            public void run() {
                ...
                try {
                    com.facebook.bolts.TaskCompletionSource.this.trySetResult(null);
                } catch (Throwable th) {
    ...
    public Task<Void> makeVoid() {
        return continueWithTask(new Continuation<TResult, Task<Void>>() { // from class: com.facebook.bolts.Task.3
    ...
    public static <TResult> Task<Task<TResult>> whenAnyResult(Collection<? extends Task<TResult>> collection) {
        ...
        while (it.hasNext()) {
            it.next().continueWith(new Continuation<TResult, Void>() { // from class: com.facebook.bolts.Task.5
                @Override // com.facebook.bolts.Continuation
    ...
    public static Task<Task<?>> whenAny(Collection<? extends Task<?>> collection) {
        ...
        while (it.hasNext()) {
            it.next().continueWith(new Continuation<Object, Void>() { // from class: com.facebook.bolts.Task.6
                @Override // com.facebook.bolts.Continuation
    ...
    public static <TResult> Task<List<TResult>> whenAllResult(final Collection<? extends Task<TResult>> collection) {
        return (Task<List<TResult>>) whenAll(collection).onSuccess(new Continuation<Void, List<TResult>>() { // from class: com.facebook.bolts.Task.7
            @Override // com.facebook.bolts.Continuation
    ...
    public static Task<Void> whenAll(Collection<? extends Task<?>> collection) {
        ...
        Iterator<? extends Task<?>> it = collection.iterator();
        while (it.hasNext()) {
            it.next().continueWith(new Continuation<Object, Void>() { // from class: com.facebook.bolts.Task.8
                @Override // com.facebook.bolts.Continuation
                public Void then(Task<Object> task) {
                    if (task.isFaulted()) {
                        synchronized (obj) {
