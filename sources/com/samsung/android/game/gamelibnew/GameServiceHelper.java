package com.samsung.android.game.gamelibnew;
...
public class GameServiceHelper {
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() { // from class: com.samsung.android.game.gamelibnew.GameServiceHelper.1
    ...
    public void bind(Context context) {
        ...
        Intent intent = new Intent("com.samsung.android.game.tsdk.SceneSdkService");
    ...
    public boolean registerListener(Listener listener) {
        ...
        if (iSceneSdkService != null) {
            ...
            try {
                return this.mGameServiceBinder.setSceneSdkListener(new ISceneSdkListener.Stub() { // from class: com.samsung.android.game.gamelibnew.GameServiceHelper.3
                    @Override // com.samsung.android.game.tsdk.ISceneSdkListener
    ...
    public int registerToTGPACallback(ToTGPACallback toTGPACallback, float f) {
        ...
        try {
            ...
            return this.mGameServiceBinder.registerToTGPACallback(new IToTGPACallback.Stub() { // from class: com.samsung.android.game.gamelibnew.GameServiceHelper.2
                @Override // com.samsung.android.game.tsdk.IToTGPACallback
