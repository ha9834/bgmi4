...
public interface Writer {
    ...
    void a(int i, Object obj, ao aoVar) throws IOException;

    void a(int i, String str) throws IOException;

    void a(int i, List<String> list) throws IOException;

    void a(int i, List<?> list, ao aoVar) throws IOException;
    ...
    @Deprecated
    void b(int i, Object obj, ao aoVar) throws IOException;

    void b(int i, List<ByteString> list) throws IOException;

    @Deprecated
    void b(int i, List<?> list, ao aoVar) throws IOException;
