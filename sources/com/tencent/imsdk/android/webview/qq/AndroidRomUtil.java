...
public class AndroidRomUtil {
    ...
    private static final String[] ROM_HUAWEI = {Constants.REFERRER_API_HUAWEI};
    ...
    private static final String[] ROM_GOOGLE = {Constants.REFERRER_API_GOOGLE};
    ...
    public static RomInfo getRomInfo() {
        ...
        if (isRightRom(brand, manufacturer, ROM_HUAWEI)) {
            ...
            String[] split = romVersion.split(EventsFilesManager.ROLL_OVER_FILE_NAME_SEPARATOR);
            if (split.length > 1) {
