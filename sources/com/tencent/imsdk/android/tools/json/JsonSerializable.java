package com.tencent.imsdk.android.tools.json;
        ...
        while (it.hasNext()) {
            ...
            if (jsonProp != null) {
                try {
                    ...
                    IMLogger.e("parse to json string error : " + e.getMessage(), new Object[0]);
                }
            }
        }
        return jSONObject;
            ...
            while (it.hasNext()) {
                ...
                if (next.isAnnotationPresent(JsonProp.class)) {
                    ...
                    try {
                        ...
                        IMLogger.w(e4.getMessage(), new Object[0]);
                    } catch (ExceptionInInitializerError e5) {
                        IMLogger.w(e5.getMessage(), new Object[0]);
                    }
                }
            }
        }
