...
public class ByteArrayPool {
    protected static final Comparator<byte[]> BUF_COMPARATOR = new Comparator<byte[]>() { // from class: com.tencent.imsdk.android.tools.net.volley.toolbox.ByteArrayPool.1
