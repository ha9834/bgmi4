...
public class RequestQueue {
    ...
    public void start() {
        ...
        for (int i = 0; i < this.mDispatchers.length; i++) {
            ...
            networkDispatcherArr[i].setName("imsdk-volley-" + i);
    ...
    public void cancelAll(final Object obj) {
        ...
        cancelAll(new RequestFilter() { // from class: com.tencent.imsdk.android.tools.net.volley.RequestQueue.1
            @Override // com.tencent.imsdk.android.tools.net.volley.RequestQueue.RequestFilter
