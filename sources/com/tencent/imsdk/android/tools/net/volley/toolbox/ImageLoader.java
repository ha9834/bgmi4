...
public class ImageLoader {
    ...
    public static ImageListener getImageListener(final ImageView imageView, final int i, final int i2) {
        return new ImageListener() { // from class: com.tencent.imsdk.android.tools.net.volley.toolbox.ImageLoader.1
            ...
            @Override // com.tencent.imsdk.android.tools.net.volley.toolbox.ImageLoader.ImageListener
    ...
    protected Request<Bitmap> makeImageRequest(String str, int i, int i2, ImageView.ScaleType scaleType, final String str2) {
        return new ImageRequest(str, new Response.Listener<Bitmap>() { // from class: com.tencent.imsdk.android.tools.net.volley.toolbox.ImageLoader.2
        ...
        }, i, i2, scaleType, Bitmap.Config.RGB_565, new Response.ErrorListener() { // from class: com.tencent.imsdk.android.tools.net.volley.toolbox.ImageLoader.3
            @Override // com.tencent.imsdk.android.tools.net.volley.Response.ErrorListener
            public void onErrorResponse(VolleyError volleyError) {
    ...
    private void batchResponse(String str, BatchedImageRequest batchedImageRequest) {
        ...
        if (this.mRunnable == null) {
            this.mRunnable = new Runnable() { // from class: com.tencent.imsdk.android.tools.net.volley.toolbox.ImageLoader.4
