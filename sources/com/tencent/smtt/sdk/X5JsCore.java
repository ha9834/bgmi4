...
public class X5JsCore {
    ...
    private static a f6499a = a.UNINITIALIZED;
    ...
    private static Object a(String str, Class<?>[] clsArr, Object... objArr) {
        try {
            r a2 = r.a();
            if (a2 != null && r.b()) {
                return a2.c().a().returnNull("com.tencent.tbs.tbsshell.WebCoreProxy", str, clsArr, objArr);
            }
    ...
    public static boolean canUseX5JsCore(Context context) {
        if (f6499a != a.UNINITIALIZED) {
            return f6499a == a.AVAILABLE;
        }
        f6499a = a.UNAVAILABLE;
