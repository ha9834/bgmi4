...
public class c extends Dialog {
    ...
    static WeakReference<ValueCallback<String>> f6510a = null;
    ...
    public c(Context context, String str, Intent intent, ValueCallback<String> valueCallback, String str2, String str3) {
        ...
        this.h = AttachmentConstants.ALLOW_ALL_MIME;
        this.k = null;
        this.i = str3;
        List<ResolveInfo> queryIntentActivities = context.getPackageManager().queryIntentActivities(intent, 65536);
        if ((queryIntentActivities == null || queryIntentActivities.size() == 0) && com.tencent.smtt.sdk.a.a.b(context)) {
        ...
        this.f = str;
        this.j = intent;
        f6510a = new WeakReference<>(valueCallback);
    ...
    public void b() {
        ...
        this.d.setOnClickListener(new View.OnClickListener() { // from class: com.tencent.smtt.sdk.b.a.c.1
            ...
            public void onClick(View view) {
                ...
                if (c.f6510a.get() != null) {
                    c.f6510a.get().onReceiveValue("always");
                }
                c.this.a(str);
                c.this.dismiss();
            }
        ...
        this.e.setOnClickListener(new View.OnClickListener() { // from class: com.tencent.smtt.sdk.b.a.c.2
            ...
            public void onClick(View view) {
                ...
                context.startActivity(intent);
                if (c.f6510a.get() != null) {
                    c.f6510a.get().onReceiveValue("once");
                }
                c.this.dismiss();
            }
        });
    ...
    private void c() {
        a aVar = this.g;
        this.g = new a(getContext(), this.j, new b(getContext(), d.a("application_icon"), "QQ浏览器", TbsConfig.APP_QB), aVar != null ? aVar.a() : null, this, this.b, f6510a.get());
