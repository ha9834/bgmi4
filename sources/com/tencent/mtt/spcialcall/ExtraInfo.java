...
public class ExtraInfo {
    ...
    private static ExtendItem ExtraBookmarkItem = null;
    private static ExtendItem ExtraDownloadItem = null;
    private static ExtendItem ExtraFavItem = null;
    private static ArrayList<ExtendItem> ExtraMoreItem = null;
    private static Bundle ExtraParams = null;
    private static ExtendItem ExtraPlusItem = null;
    private static ArrayList<ExtendItem> ExtraShareItem = null;
    private static ArrayList<ExtendItem> ExtraThemeItem = null;
    private static ArrayList<ExtendItem> ExtraTitleItem = null;
    private static boolean HasBookmark = false;
    private static boolean HasFav = false;
    private static boolean HasReadMode = false;
    private static int MenuStyle = 0;
    ...
    private static String WhiteListPattern;
    private static String oriPkg;
    ...
    public static void setOriPkg(String str) {
        oriPkg = str;
    }
    ...
    public static int getAppID() {
        if ("com.tencent.mobileqq".equals(oriPkg)) {
            return 2;
        }
        ...
        return "com.qzone".equals(oriPkg) ? 3 : -1;
    }
