...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory f802a = new ThreadFactory() { // from class: androidx.loader.content.ModernAsyncTask.1

        /* renamed from: a, reason: collision with root package name */
        private final AtomicInteger f803a = new AtomicInteger(1);

        @Override // java.util.concurrent.ThreadFactory
        public Thread newThread(Runnable runnable) {
            return new Thread(runnable, "ModernAsyncTask #" + this.f803a.getAndIncrement());
        }
    };
    private static final BlockingQueue<Runnable> b = new LinkedBlockingQueue(10);
    public static final Executor c = new ThreadPoolExecutor(5, 128, 1, TimeUnit.SECONDS, b, f802a);
    ...
    public static class b extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                case 1:
                    aVar.f808a.e(aVar.b[0]);
                    return;
                case 2:
                    aVar.f808a.b((Object[]) aVar.b);
                    return;
                default:
                    return;
            }
    ...
    public static class a<Data> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final ModernAsyncTask f808a;
        final Data[] b;

        a(ModernAsyncTask modernAsyncTask, Data... dataArr) {
            this.f808a = modernAsyncTask;
            this.b = dataArr;
        }
    }
}
