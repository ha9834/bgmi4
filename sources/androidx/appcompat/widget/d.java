...
public class d extends AutoCompleteTextView implements androidx.core.f.u {

    /* renamed from: a, reason: collision with root package name */
    private static final int[] f352a = {R.attr.popupBackground};
    private final e b;
    private final w c;
    ...
    public d(Context context, AttributeSet attributeSet, int i) {
        ...
        au a2 = au.a(getContext(), attributeSet, f352a, i, 0);
        if (a2.g(0)) {
