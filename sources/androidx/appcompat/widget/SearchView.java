...
public class SearchView extends ag implements androidx.appcompat.view.c {
    ...
    androidx.c.a.a mSuggestionsAdapter;
    private int[] mTemp;
    private int[] mTemp2;
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, a.C0024a.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mReleaseCursorRunnable = new Runnable() { // from class: androidx.appcompat.widget.SearchView.3
            @Override // java.lang.Runnable
            public void run() {
                if (SearchView.this.mSuggestionsAdapter instanceof ao) {
        ...
        this.mTextKeyListener = new View.OnKeyListener() { // from class: androidx.appcompat.widget.SearchView.7
            ...
            public boolean onKey(View view, int i2, KeyEvent keyEvent) {
                ...
                if (SearchView.this.mSearchSrcTextView.a() || !keyEvent.hasNoModifiers() || keyEvent.getAction() != 1 || i2 != 66) {
                    return false;
                }
        ...
        au a2 = au.a(context, attributeSet, a.j.SearchView, i, 0);
        ...
        androidx.core.f.v.a(this.mSearchPlate, a2.a(a.j.SearchView_queryBackground));
        androidx.core.f.v.a(this.mSubmitArea, a2.a(a.j.SearchView_submitBackground));
        ...
        aw.a(this.mSearchButton, getResources().getString(a.h.abc_searchview_description_search));
    ...
    public void setQueryRefinementEnabled(boolean z) {
        ...
        androidx.c.a.a aVar = this.mSuggestionsAdapter;
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (z) {
            ...
            if (eVar == null) {
                ...
                eVar.a(this.mSearchSrtTextViewBoundsExpanded, this.mSearchSrcTextViewBounds);
            }
        }
    }
    ...
    private void updateSearchAutoComplete() {
        ...
        if (this.mSearchable.getSuggestAuthority() != null) {
            this.mSuggestionsAdapter = new ao(getContext(), this, this.mSearchable, this.mOutsideDrawablesCache);
            this.mSearchSrcTextView.setAdapter(this.mSuggestionsAdapter);
            ((ao) this.mSuggestionsAdapter).a(this.mQueryRefinement ? 2 : 1);
        }
    }
    ...
    void onSubmitQuery() {
        ...
        c cVar = this.mOnQueryChangeListener;
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f295a = ((Boolean) parcel.readValue(null)).booleanValue();
        }

        @Override // androidx.customview.view.AbsSavedState, android.os.Parcelable
        public void writeToParcel(Parcel parcel, int i) {
            super.writeToParcel(parcel, i);
            parcel.writeValue(Boolean.valueOf(this.f295a));
        }

        public String toString() {
            return "SearchView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " isIconified=" + this.f295a + "}";
        }
    }
    ...
    protected void onRestoreInstanceState(Parcelable parcelable) {
        ...
        updateViewsVisibility(savedState.f295a);
        requestLayout();
    }
    ...
    boolean onItemClicked(int i, int i2, String str) {
        d dVar = this.mOnSuggestionListener;
    ...
    private void rewriteQueryFromSuggestion(int i) {
        Editable text = this.mSearchSrcTextView.getText();
        Cursor a2 = this.mSuggestionsAdapter.a();
        if (a2 == null) {
            return;
        }
        if (a2.moveToPosition(i)) {
            CharSequence b2 = this.mSuggestionsAdapter.b(a2);
            if (b2 != null) {
                setQuery(b2);
                return;
            } else {
    ...
    private boolean launchSuggestion(int i, int i2, String str) {
        ...
        launchIntent(createIntentFromSuggestion(a2, i2, str));
        return true;
    }
    ...
    private Intent createIntentFromSuggestion(Cursor cursor, int i, String str) {
        ...
        try {
            ...
            if (a3 == null) {
                a3 = this.mSearchable.getSuggestIntentAction();
            }
            String str2 = a3 == null ? "android.intent.action.SEARCH" : a3;
            String a4 = ao.a(cursor, "suggest_intent_data");
            if (a4 == null) {
                a4 = this.mSearchable.getSuggestIntentData();
            }
            if (a4 != null && (a2 = ao.a(cursor, "suggest_intent_data_id")) != null) {
                a4 = a4 + "/" + Uri.encode(a2);
            }
            return createIntent(str2, a4 == null ? null : Uri.parse(a4), ao.a(cursor, "suggest_intent_extra_data"), ao.a(cursor, "suggest_intent_query"), i, str);
        } catch (RuntimeException e2) {
            try {
    ...
    private static class e extends TouchDelegate {
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (z2 && !this.c.contains(x, y)) {
                motionEvent.setLocation(this.f299a.getWidth() / 2, this.f299a.getHeight() / 2);
            } else {
                motionEvent.setLocation(x - this.c.left, y - this.c.top);
            }
            return this.f299a.dispatchTouchEvent(motionEvent);
        }
    }
    ...
    public static class SearchAutoComplete extends androidx.appcompat.widget.d {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet, int i) {
            super(context, attributeSet, i);
            this.f296a = new Runnable() { // from class: androidx.appcompat.widget.SearchView.SearchAutoComplete.1
                @Override // java.lang.Runnable
                public void run() {
    ...
    public static class a {
        ...
        /* renamed from: a, reason: collision with root package name */
        private Method f298a;
        private Method b;
        private Method c;

        a() {
            try {
                this.f298a = AutoCompleteTextView.class.getDeclaredMethod("doBeforeTextChanged", new Class[0]);
                this.f298a.setAccessible(true);
