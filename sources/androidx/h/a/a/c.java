...
public class c extends h implements androidx.h.a.a.b {
    ...
    public int getChangingConfigurations() {
        ...
        return super.getChangingConfigurations() | this.d.f748a;
    }
    ...
    private static class b extends Drawable.ConstantState {
        ...
        public Drawable newDrawable(Resources resources) {
            c cVar = new c();
            cVar.c = this.f749a.newDrawable(resources);
            cVar.c.setCallback(cVar.b);
            return cVar;
        }
        ...
        public Drawable newDrawable(Resources resources, Resources.Theme theme) {
            c cVar = new c();
            cVar.c = this.f749a.newDrawable(resources, theme);
            cVar.c.setCallback(cVar.b);
            return cVar;
        }
