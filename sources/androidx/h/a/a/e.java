...
public class e {
    ...
    public static class a implements TypeEvaluator<d.b[]> {
        ...
        public d.b[] evaluate(float f, d.b[] bVarArr, d.b[] bVarArr2) {
            if (!androidx.core.graphics.d.a(bVarArr, bVarArr2)) {
                throw new IllegalArgumentException("Can't interpolate between two incompatible pathData");
            }
            if (!androidx.core.graphics.d.a(this.f750a, bVarArr)) {
                this.f750a = androidx.core.graphics.d.a(bVarArr);
            }
            for (int i = 0; i < bVarArr.length; i++) {
                this.f750a[i].a(bVarArr[i], bVarArr2[i], f);
            }
            return this.f750a;
        }
    }
    ...
    private static PropertyValuesHolder a(TypedArray typedArray, int i, int i2, int i3, String str) {
        ...
        if (i == 2) {
            ...
            d.b[] b = androidx.core.graphics.d.b(string);
            d.b[] b2 = androidx.core.graphics.d.b(string2);
            if (b == null && b2 == null) {
                return null;
            }
            if (b == null) {
            ...
            if (androidx.core.graphics.d.a(b, b2)) {
    ...
    private static void a(ValueAnimator valueAnimator, TypedArray typedArray, int i, float f, XmlPullParser xmlPullParser) {
        ...
        if (a2 != null) {
            ...
            a(androidx.core.graphics.d.a(a2), objectAnimator, f * 0.5f, a3, a4);
            return;
        }
