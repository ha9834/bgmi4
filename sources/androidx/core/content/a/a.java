    ...
    private static ColorStateList b(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals("item")) {
                TypedArray a2 = a(resources, theme, attributeSet, a.d.ColorStateListItem);
                int color = a2.getColor(a.d.ColorStateListItem_android_color, -65281);
                float f = 1.0f;
                if (a2.hasValue(a.d.ColorStateListItem_android_alpha)) {
                    f = a2.getFloat(a.d.ColorStateListItem_android_alpha, 1.0f);
                } else if (a2.hasValue(a.d.ColorStateListItem_alpha)) {
                    f = a2.getFloat(a.d.ColorStateListItem_alpha, 1.0f);
                }
                a2.recycle();
                ...
                for (int i4 = 0; i4 < attributeCount; i4++) {
                    ...
                    if (attributeNameResource != 16843173 && attributeNameResource != 16843551 && attributeNameResource != a.C0041a.alpha) {
                        int i5 = i3 + 1;
