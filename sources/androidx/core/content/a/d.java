...
public final class d {
    ...
    public static Shader a(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws IOException, XmlPullParserException {
        ...
        int a9 = g.a(a2, xmlPullParser, "type", a.d.GradientColor_android_type, 0);
        ...
        switch (a9) {
            case 1:
                ...
                return new RadialGradient(a7, a8, a12, a13.f500a, a13.b, a(a11));
            case 2:
                return new SweepGradient(a7, a8, a13.f500a, a13.b);
            default:
                return new LinearGradient(a3, a4, a5, a6, a13.f500a, a13.b, a(a11));
        }
    }
    ...
    */
    ...
    public static final class a {
        ...
        a(List<Integer> list, List<Float> list2) {
            int size = list.size();
            this.f500a = new int[size];
            this.b = new float[size];
            for (int i = 0; i < size; i++) {
                this.f500a[i] = list.get(i).intValue();
                this.b[i] = list2.get(i).floatValue();
            }
        }

        a(int i, int i2) {
            this.f500a = new int[]{i, i2};
            this.b = new float[]{0.0f, 1.0f};
        }

        a(int i, int i2, int i3) {
            this.f500a = new int[]{i, i2, i3};
