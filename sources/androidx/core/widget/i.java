...
public final class i {
    ...
    private static class a implements ActionMode.Callback {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final ActionMode.Callback f580a;
        ...
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            return this.f580a.onCreateActionMode(actionMode, menu);
        }

        @Override // android.view.ActionMode.Callback
        public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
            a(menu);
            return this.f580a.onPrepareActionMode(actionMode, menu);
        }

        @Override // android.view.ActionMode.Callback
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            return this.f580a.onActionItemClicked(actionMode, menuItem);
        }

        @Override // android.view.ActionMode.Callback
        public void onDestroyActionMode(ActionMode actionMode) {
            this.f580a.onDestroyActionMode(actionMode);
        }
    ...
    public static b.a e(TextView textView) {
        ...
        b.a.C0045a c0045a = new b.a.C0045a(new TextPaint(textView.getPaint()));
        if (Build.VERSION.SDK_INT >= 23) {
            c0045a.a(textView.getBreakStrategy());
            c0045a.b(textView.getHyphenationFrequency());
        }
        if (Build.VERSION.SDK_INT >= 18) {
            c0045a.a(f(textView));
        }
    ...
    public static void a(TextView textView, androidx.core.d.b bVar) {
        if (Build.VERSION.SDK_INT >= 29) {
            textView.setText(bVar.a());
        } else {
            if (!e(textView).a(bVar.b())) {
